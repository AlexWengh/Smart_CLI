...
void CScintillaCtrl::ChangeInsertion(int length, const wchar_t* text, BOOL bDirect)
{
  //Convert the unicode text to UTF8
  CStringA sUTF8(W2UTF8(text, -1));

  //Call the native scintilla version of the function with the UTF8 text
  ChangeInsertion(length, sUTF8, bDirect);
}
...
{
  //Work out the length of string to allocate
  int nLength = GetSelText(NULL, bDirect);
...
void CScintillaCtrl::ChangeInsertion(int length, const char* text, BOOL bDirect)
{
  Call(SCI_CHANGEINSERTION, static_cast<WPARAM>(length), reinterpret_cast<LPARAM>(text), bDirect);
}
...
{
  return static_cast<int>(Call(SCI_GETLENGTH, 0, 0, bDirect));
}

int CScintillaCtrl::GetCharAt(long pos, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETCHARAT, static_cast<WPARAM>(pos), 0, bDirect));
}

long CScintillaCtrl::GetCurrentPos(BOOL bDirect)
{
  return static_cast<long>(Call(SCI_GETCURRENTPOS, 0, 0, bDirect));
}

long CScintillaCtrl::GetAnchor(BOOL bDirect)
{
  return static_cast<long>(Call(SCI_GETANCHOR, 0, 0, bDirect));
}

int CScintillaCtrl::GetStyleAt(long pos, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETSTYLEAT, static_cast<WPARAM>(pos), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETSTYLEDTEXT, 0, reinterpret_cast<LPARAM>(tr), bDirect));
}

BOOL CScintillaCtrl::CanRedo(BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_CANREDO, 0, 0, bDirect));
}

int CScintillaCtrl::MarkerLineFromHandle(int handle, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_MARKERLINEFROMHANDLE, static_cast<WPARAM>(handle), 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETUNDOCOLLECTION, 0, 0, bDirect));
}

int CScintillaCtrl::GetViewWS(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETVIEWWS, 0, 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_POSITIONFROMPOINT, static_cast<WPARAM>(x), static_cast<LPARAM>(y), bDirect));
}

long CScintillaCtrl::PositionFromPointClose(int x, int y, BOOL bDirect)
{
  return static_cast<long>(Call(SCI_POSITIONFROMPOINTCLOSE, static_cast<WPARAM>(x), static_cast<LPARAM>(y), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETCURLINE, static_cast<WPARAM>(length), reinterpret_cast<LPARAM>(text), bDirect));
}

long CScintillaCtrl::GetEndStyled(BOOL bDirect)
{
  return static_cast<long>(Call(SCI_GETENDSTYLED, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETEOLMODE, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETBUFFEREDDRAW, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETTABWIDTH, 0, 0, bDirect));
}

void CScintillaCtrl::ClearTabStops(int line, BOOL bDirect)
{
  Call(SCI_CLEARTABSTOPS, static_cast<WPARAM>(line), 0, bDirect);
}

void CScintillaCtrl::AddTabStop(int line, int x, BOOL bDirect)
{
  Call(SCI_ADDTABSTOP, static_cast<WPARAM>(line), static_cast<LPARAM>(x), bDirect);
}

int CScintillaCtrl::GetNextTabStop(int line, int x, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETNEXTTABSTOP, static_cast<WPARAM>(line), static_cast<LPARAM>(x), bDirect));
}
...
int CScintillaCtrl::GetIMEInteraction(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETIMEINTERACTION, 0, 0, bDirect));
}

void CScintillaCtrl::SetIMEInteraction(int imeInteraction, BOOL bDirect)
{
  Call(SCI_SETIMEINTERACTION, static_cast<WPARAM>(imeInteraction), 0, bDirect);
}
...
{
  return static_cast<int>(Call(SCI_MARKERADD, static_cast<WPARAM>(line), static_cast<LPARAM>(markerNumber), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_MARKERGET, static_cast<WPARAM>(line), 0, bDirect));
}

int CScintillaCtrl::MarkerNext(int lineStart, int markerMask, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_MARKERNEXT, static_cast<WPARAM>(lineStart), static_cast<LPARAM>(markerMask), bDirect));
}

int CScintillaCtrl::MarkerPrevious(int lineStart, int markerMask, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_MARKERPREVIOUS, static_cast<WPARAM>(lineStart), static_cast<LPARAM>(markerMask), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETMARGINTYPEN, static_cast<WPARAM>(margin), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETMARGINWIDTHN, static_cast<WPARAM>(margin), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETMARGINMASKN, static_cast<WPARAM>(margin), 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETMARGINSENSITIVEN, static_cast<WPARAM>(margin), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETMARGINCURSORN, static_cast<WPARAM>(margin), 0, bDirect));
}
...
{
  return static_cast<COLORREF>(Call(SCI_STYLEGETFORE, static_cast<WPARAM>(style), 0, bDirect));
}

COLORREF CScintillaCtrl::StyleGetBack(int style, BOOL bDirect)
{
  return static_cast<COLORREF>(Call(SCI_STYLEGETBACK, static_cast<WPARAM>(style), 0, bDirect));
}

BOOL CScintillaCtrl::StyleGetBold(int style, BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_STYLEGETBOLD, static_cast<WPARAM>(style), 0, bDirect));
}

BOOL CScintillaCtrl::StyleGetItalic(int style, BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_STYLEGETITALIC, static_cast<WPARAM>(style), 0, bDirect));
}

int CScintillaCtrl::StyleGetSize(int style, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_STYLEGETSIZE, static_cast<WPARAM>(style), 0, bDirect));
}

int CScintillaCtrl::StyleGetFont(int style, char* fontName, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_STYLEGETFONT, static_cast<WPARAM>(style), reinterpret_cast<LPARAM>(fontName), bDirect));
}

BOOL CScintillaCtrl::StyleGetEOLFilled(int style, BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_STYLEGETEOLFILLED, static_cast<WPARAM>(style), 0, bDirect));
}

BOOL CScintillaCtrl::StyleGetUnderline(int style, BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_STYLEGETUNDERLINE, static_cast<WPARAM>(style), 0, bDirect));
}

int CScintillaCtrl::StyleGetCase(int style, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_STYLEGETCASE, static_cast<WPARAM>(style), 0, bDirect));
}

int CScintillaCtrl::StyleGetCharacterSet(int style, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_STYLEGETCHARACTERSET, static_cast<WPARAM>(style), 0, bDirect));
}

BOOL CScintillaCtrl::StyleGetVisible(int style, BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_STYLEGETVISIBLE, static_cast<WPARAM>(style), 0, bDirect));
}

BOOL CScintillaCtrl::StyleGetChangeable(int style, BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_STYLEGETCHANGEABLE, static_cast<WPARAM>(style), 0, bDirect));
}

BOOL CScintillaCtrl::StyleGetHotSpot(int style, BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_STYLEGETHOTSPOT, static_cast<WPARAM>(style), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_STYLEGETSIZEFRACTIONAL, static_cast<WPARAM>(style), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_STYLEGETWEIGHT, static_cast<WPARAM>(style), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETSELALPHA, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETSELEOLFILLED, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETCARETPERIOD, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETWORDCHARS, 0, reinterpret_cast<LPARAM>(characters), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_INDICGETSTYLE, static_cast<WPARAM>(indic), 0, bDirect));
}
...
{
  return static_cast<COLORREF>(Call(SCI_INDICGETFORE, static_cast<WPARAM>(indic), 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_INDICGETUNDER, static_cast<WPARAM>(indic), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETWHITESPACESIZE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETSTYLEBITS, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETLINESTATE, static_cast<WPARAM>(line), 0, bDirect));
}

int CScintillaCtrl::GetMaxLineState(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETMAXLINESTATE, 0, 0, bDirect));
}

BOOL CScintillaCtrl::GetCaretLineVisible(BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_GETCARETLINEVISIBLE, 0, 0, bDirect));
}
...
{
  return static_cast<COLORREF>(Call(SCI_GETCARETLINEBACK, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_AUTOCACTIVE, 0, 0, bDirect));
}

long CScintillaCtrl::AutoCPosStart(BOOL bDirect)
{
  return static_cast<long>(Call(SCI_AUTOCPOSSTART, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_AUTOCGETSEPARATOR, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_AUTOCGETCANCELATSTART, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_AUTOCGETCHOOSESINGLE, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_AUTOCGETIGNORECASE, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_AUTOCGETAUTOHIDE, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_AUTOCGETDROPRESTOFWORD, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_AUTOCGETTYPESEPARATOR, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_AUTOCGETMAXWIDTH, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_AUTOCGETMAXHEIGHT, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETINDENT, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETUSETABS, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETLINEINDENTATION, static_cast<WPARAM>(line), 0, bDirect));
}

long CScintillaCtrl::GetLineIndentPosition(int line, BOOL bDirect)
{
  return static_cast<long>(Call(SCI_GETLINEINDENTPOSITION, static_cast<WPARAM>(line), 0, bDirect));
}

int CScintillaCtrl::GetColumn(long pos, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETCOLUMN, static_cast<WPARAM>(pos), 0, bDirect));
}

int CScintillaCtrl::CountCharacters(int startPos, int endPos, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_COUNTCHARACTERS, static_cast<WPARAM>(startPos), static_cast<LPARAM>(endPos), bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETHSCROLLBAR, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETINDENTATIONGUIDES, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETHIGHLIGHTGUIDE, 0, 0, bDirect));
}

long CScintillaCtrl::GetLineEndPosition(int line, BOOL bDirect)
{
  return static_cast<long>(Call(SCI_GETLINEENDPOSITION, static_cast<WPARAM>(line), 0, bDirect));
}

int CScintillaCtrl::GetCodePage(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETCODEPAGE, 0, 0, bDirect));
}

COLORREF CScintillaCtrl::GetCaretFore(BOOL bDirect)
{
  return static_cast<COLORREF>(Call(SCI_GETCARETFORE, 0, 0, bDirect));
}

BOOL CScintillaCtrl::GetReadOnly(BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_GETREADONLY, 0, 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_GETSELECTIONSTART, 0, 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_GETSELECTIONEND, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETPRINTMAGNIFICATION, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETPRINTCOLOURMODE, 0, 0, bDirect));
}

long CScintillaCtrl::FindText(int flags, TextToFind* ft, BOOL bDirect)
{
  return static_cast<long>(Call(SCI_FINDTEXT, static_cast<WPARAM>(flags), reinterpret_cast<LPARAM>(ft), bDirect));
}

long CScintillaCtrl::FormatRange(BOOL draw, RangeToFormat* fr, BOOL bDirect)
{
  return static_cast<long>(Call(SCI_FORMATRANGE, static_cast<WPARAM>(draw), reinterpret_cast<LPARAM>(fr), bDirect));
}

int CScintillaCtrl::GetFirstVisibleLine(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETFIRSTVISIBLELINE, 0, 0, bDirect));
}

int CScintillaCtrl::GetLine(int line, char* text, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETLINE, static_cast<WPARAM>(line), reinterpret_cast<LPARAM>(text), bDirect));
}

int CScintillaCtrl::GetLineCount(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETLINECOUNT, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETMARGINLEFT, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETMARGINRIGHT, 0, 0, bDirect));
}

BOOL CScintillaCtrl::GetModify(BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_GETMODIFY, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETSELTEXT, 0, reinterpret_cast<LPARAM>(text), bDirect));
}

int CScintillaCtrl::GetTextRange(TextRange* tr, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETTEXTRANGE, 0, reinterpret_cast<LPARAM>(tr), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_POINTXFROMPOSITION, 0, static_cast<LPARAM>(pos), bDirect));
}

int CScintillaCtrl::PointYFromPosition(long pos, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_POINTYFROMPOSITION, 0, static_cast<LPARAM>(pos), bDirect));
}

int CScintillaCtrl::LineFromPosition(long pos, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_LINEFROMPOSITION, static_cast<WPARAM>(pos), 0, bDirect));
}

long CScintillaCtrl::PositionFromLine(int line, BOOL bDirect)
{
  return static_cast<long>(Call(SCI_POSITIONFROMLINE, static_cast<WPARAM>(line), 0, bDirect));
}
...
{
  Call(SCI_SCROLLRANGE, static_cast<WPARAM>(secondary), static_cast<LPARAM>(primary), bDirect);
}
...
{
  return static_cast<BOOL>(Call(SCI_CANPASTE, 0, 0, bDirect));
}

BOOL CScintillaCtrl::CanUndo(BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_CANUNDO, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETTEXT, static_cast<WPARAM>(length), reinterpret_cast<LPARAM>(text), bDirect));
}

int CScintillaCtrl::GetTextLength(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETTEXTLENGTH, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETOVERTYPE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETCARETWIDTH, 0, 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_GETTARGETSTART, 0, 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_GETTARGETEND, 0, 0, bDirect));
}

int CScintillaCtrl::ReplaceTarget(int length, const char* text, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_REPLACETARGET, static_cast<WPARAM>(length), reinterpret_cast<LPARAM>(text), bDirect));
}

int CScintillaCtrl::ReplaceTargetRE(int length, const char* text, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_REPLACETARGETRE, static_cast<WPARAM>(length), reinterpret_cast<LPARAM>(text), bDirect));
}

int CScintillaCtrl::SearchInTarget(int length, const char* text, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_SEARCHINTARGET, static_cast<WPARAM>(length), reinterpret_cast<LPARAM>(text), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETSEARCHFLAGS, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_CALLTIPACTIVE, 0, 0, bDirect));
}

long CScintillaCtrl::CallTipPosStart(BOOL bDirect)
{
  return static_cast<long>(Call(SCI_CALLTIPPOSSTART, 0, 0, bDirect));
}

void CScintillaCtrl::CallTipSetPosStart(int posStart, BOOL bDirect)
{
  Call(SCI_CALLTIPSETPOSSTART, static_cast<WPARAM>(posStart), 0, bDirect);
}
...
{
  return static_cast<int>(Call(SCI_VISIBLEFROMDOCLINE, static_cast<WPARAM>(line), 0, bDirect));
}

int CScintillaCtrl::DocLineFromVisible(int lineDisplay, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_DOCLINEFROMVISIBLE, static_cast<WPARAM>(lineDisplay), 0, bDirect));
}

int CScintillaCtrl::WrapCount(int line, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_WRAPCOUNT, static_cast<WPARAM>(line), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETFOLDLEVEL, static_cast<WPARAM>(line), 0, bDirect));
}

int CScintillaCtrl::GetLastChild(int line, int level, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETLASTCHILD, static_cast<WPARAM>(line), static_cast<LPARAM>(level), bDirect));
}

int CScintillaCtrl::GetFoldParent(int line, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETFOLDPARENT, static_cast<WPARAM>(line), 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETLINEVISIBLE, static_cast<WPARAM>(line), 0, bDirect));
}

BOOL CScintillaCtrl::GetAllLinesVisible(BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_GETALLLINESVISIBLE, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETFOLDEXPANDED, static_cast<WPARAM>(line), 0, bDirect));
}
...
{
  Call(SCI_FOLDLINE, static_cast<WPARAM>(line), static_cast<LPARAM>(action), bDirect);
}

void CScintillaCtrl::FoldChildren(int line, int action, BOOL bDirect)
{
  Call(SCI_FOLDCHILDREN, static_cast<WPARAM>(line), static_cast<LPARAM>(action), bDirect);
}

void CScintillaCtrl::ExpandChildren(int line, int level, BOOL bDirect)
{
  Call(SCI_EXPANDCHILDREN, static_cast<WPARAM>(line), static_cast<LPARAM>(level), bDirect);
}

void CScintillaCtrl::FoldAll(int action, BOOL bDirect)
{
  Call(SCI_FOLDALL, static_cast<WPARAM>(action), 0, bDirect);
}
...
{
  Call(SCI_SETAUTOMATICFOLD, static_cast<WPARAM>(automaticFold), 0, bDirect);
}

int CScintillaCtrl::GetAutomaticFold(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETAUTOMATICFOLD, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETTABINDENTS, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETBACKSPACEUNINDENTS, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETMOUSEDWELLTIME, 0, 0, bDirect));
}

int CScintillaCtrl::WordStartPosition(long pos, BOOL onlyWordCharacters, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_WORDSTARTPOSITION, static_cast<WPARAM>(pos), static_cast<LPARAM>(onlyWordCharacters), bDirect));
}

int CScintillaCtrl::WordEndPosition(long pos, BOOL onlyWordCharacters, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_WORDENDPOSITION, static_cast<WPARAM>(pos), static_cast<LPARAM>(onlyWordCharacters), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETWRAPMODE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETWRAPVISUALFLAGS, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETWRAPVISUALFLAGSLOCATION, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETWRAPSTARTINDENT, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETWRAPINDENTMODE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETLAYOUTCACHE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETSCROLLWIDTH, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETSCROLLWIDTHTRACKING, 0, 0, bDirect));
}

int CScintillaCtrl::TextWidth(int style, const char* text, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_TEXTWIDTH, static_cast<WPARAM>(style), reinterpret_cast<LPARAM>(text), bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETENDATLASTLINE, 0, 0, bDirect));
}

int CScintillaCtrl::TextHeight(int line, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_TEXTHEIGHT, static_cast<WPARAM>(line), 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETVSCROLLBAR, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETTWOPHASEDRAW, 0, 0, bDirect));
}
...
int CScintillaCtrl::GetPhasesDraw(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETPHASESDRAW, 0, 0, bDirect));
}

void CScintillaCtrl::SetPhasesDraw(int phases, BOOL bDirect)
{
  Call(SCI_SETPHASESDRAW, static_cast<WPARAM>(phases), 0, bDirect);
}
...
{
  return static_cast<int>(Call(SCI_GETFONTQUALITY, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETMULTIPASTE, 0, 0, bDirect));
}

int CScintillaCtrl::GetTag(int tagNumber, char* tagValue, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETTAG, static_cast<WPARAM>(tagNumber), reinterpret_cast<LPARAM>(tagValue), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_LINELENGTH, static_cast<WPARAM>(line), 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_BRACEMATCH, static_cast<WPARAM>(pos), 0, bDirect));
}

BOOL CScintillaCtrl::GetViewEOL(BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_GETVIEWEOL, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETEDGECOLUMN, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETEDGEMODE, 0, 0, bDirect));
}
...
{
  return static_cast<COLORREF>(Call(SCI_GETEDGECOLOUR, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_SEARCHNEXT, static_cast<WPARAM>(flags), reinterpret_cast<LPARAM>(text), bDirect));
}

int CScintillaCtrl::SearchPrev(int flags, const char* text, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_SEARCHPREV, static_cast<WPARAM>(flags), reinterpret_cast<LPARAM>(text), bDirect));
}

int CScintillaCtrl::LinesOnScreen(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_LINESONSCREEN, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_SELECTIONISRECTANGLE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETZOOM, 0, 0, bDirect));
}

int CScintillaCtrl::CreateDocument(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_CREATEDOCUMENT, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETMODEVENTMASK, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETFOCUS, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETSTATUS, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETMOUSEDOWNCAPTURES, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETCURSOR, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETCONTROLCHARSYMBOL, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETXOFFSET, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETPRINTWRAPMODE, 0, 0, bDirect));
}
...
{
  return static_cast<COLORREF>(Call(SCI_GETHOTSPOTACTIVEFORE, 0, 0, bDirect));
}
...
{
  return static_cast<COLORREF>(Call(SCI_GETHOTSPOTACTIVEBACK, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETHOTSPOTACTIVEUNDERLINE, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETHOTSPOTSINGLELINE, 0, 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_POSITIONBEFORE, static_cast<WPARAM>(pos), 0, bDirect));
}

long CScintillaCtrl::PositionAfter(long pos, BOOL bDirect)
{
  return static_cast<long>(Call(SCI_POSITIONAFTER, static_cast<WPARAM>(pos), 0, bDirect));
}

long CScintillaCtrl::PositionRelative(long pos, int relative, BOOL bDirect)
{
  return static_cast<long>(Call(SCI_POSITIONRELATIVE, static_cast<WPARAM>(pos), static_cast<LPARAM>(relative), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETSELECTIONMODE, 0, 0, bDirect));
}

long CScintillaCtrl::GetLineSelStartPosition(int line, BOOL bDirect)
{
  return static_cast<long>(Call(SCI_GETLINESELSTARTPOSITION, static_cast<WPARAM>(line), 0, bDirect));
}

long CScintillaCtrl::GetLineSelEndPosition(int line, BOOL bDirect)
{
  return static_cast<long>(Call(SCI_GETLINESELENDPOSITION, static_cast<WPARAM>(line), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETWHITESPACECHARS, 0, reinterpret_cast<LPARAM>(characters), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETPUNCTUATIONCHARS, 0, reinterpret_cast<LPARAM>(characters), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_AUTOCGETCURRENT, 0, 0, bDirect));
}

int CScintillaCtrl::AutoCGetCurrentText(char* s, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_AUTOCGETCURRENTTEXT, 0, reinterpret_cast<LPARAM>(s), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_AUTOCGETCASEINSENSITIVEBEHAVIOUR, 0, 0, bDirect));
}

void CScintillaCtrl::AutoCSetMulti(int multi, BOOL bDirect)
{
  Call(SCI_AUTOCSETMULTI, static_cast<WPARAM>(multi), 0, bDirect);
}

int CScintillaCtrl::AutoCGetMulti(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_AUTOCGETMULTI, 0, 0, bDirect));
}

void CScintillaCtrl::AutoCSetOrder(int order, BOOL bDirect)
{
  Call(SCI_AUTOCSETORDER, static_cast<WPARAM>(order), 0, bDirect);
}

int CScintillaCtrl::AutoCGetOrder(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_AUTOCGETORDER, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_TARGETASUTF8, 0, reinterpret_cast<LPARAM>(s), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_ENCODEDFROMUTF8, reinterpret_cast<WPARAM>(utf8), reinterpret_cast<LPARAM>(encoded), bDirect));
}

int CScintillaCtrl::FindColumn(int line, int column, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_FINDCOLUMN, static_cast<WPARAM>(line), static_cast<LPARAM>(column), bDirect));
}

int CScintillaCtrl::GetCaretSticky(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETCARETSTICKY, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETPASTECONVERTENDINGS, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETCARETLINEBACKALPHA, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETCARETSTYLE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETINDICATORCURRENT, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETINDICATORVALUE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_INDICATORALLONFOR, static_cast<WPARAM>(position), 0, bDirect));
}

int CScintillaCtrl::IndicatorValueAt(int indicator, int position, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_INDICATORVALUEAT, static_cast<WPARAM>(indicator), static_cast<LPARAM>(position), bDirect));
}

int CScintillaCtrl::IndicatorStart(int indicator, int position, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_INDICATORSTART, static_cast<WPARAM>(indicator), static_cast<LPARAM>(position), bDirect));
}

int CScintillaCtrl::IndicatorEnd(int indicator, int position, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_INDICATOREND, static_cast<WPARAM>(indicator), static_cast<LPARAM>(position), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETPOSITIONCACHE, 0, 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_GETGAPPOSITION, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETKEYSUNICODE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_INDICGETALPHA, static_cast<WPARAM>(indicator), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_INDICGETOUTLINEALPHA, static_cast<WPARAM>(indicator), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETEXTRAASCENT, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETEXTRADESCENT, 0, 0, bDirect));
}

int CScintillaCtrl::MarkerSymbolDefined(int markerNumber, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_MARKERSYMBOLDEFINED, static_cast<WPARAM>(markerNumber), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_MARGINGETTEXT, static_cast<WPARAM>(line), reinterpret_cast<LPARAM>(text), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_MARGINGETSTYLE, static_cast<WPARAM>(line), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_MARGINGETSTYLES, static_cast<WPARAM>(line), reinterpret_cast<LPARAM>(styles), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_MARGINGETSTYLEOFFSET, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETMARGINOPTIONS, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_ANNOTATIONGETTEXT, static_cast<WPARAM>(line), reinterpret_cast<LPARAM>(text), bDirect));
}
...
{
  return static_cast<int>(Call(SCI_ANNOTATIONGETSTYLE, static_cast<WPARAM>(line), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_ANNOTATIONGETSTYLES, static_cast<WPARAM>(line), reinterpret_cast<LPARAM>(styles), bDirect));
}

int CScintillaCtrl::AnnotationGetLines(int line, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_ANNOTATIONGETLINES, static_cast<WPARAM>(line), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_ANNOTATIONGETVISIBLE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_ANNOTATIONGETSTYLEOFFSET, 0, 0, bDirect));
}

void CScintillaCtrl::ReleaseAllExtendedStyles(BOOL bDirect)
{
  Call(SCI_RELEASEALLEXTENDEDSTYLES, 0, 0, bDirect);
}

int CScintillaCtrl::AllocateExtendedStyles(int numberStyles, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_ALLOCATEEXTENDEDSTYLES, static_cast<WPARAM>(numberStyles), 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_CHARPOSITIONFROMPOINT, static_cast<WPARAM>(x), static_cast<LPARAM>(y), bDirect));
}

long CScintillaCtrl::CharPositionFromPointClose(int x, int y, BOOL bDirect)
{
  return static_cast<long>(Call(SCI_CHARPOSITIONFROMPOINTCLOSE, static_cast<WPARAM>(x), static_cast<LPARAM>(y), bDirect));
}

void CScintillaCtrl::SetMouseSelectionRectangularSwitch(BOOL mouseSelectionRectangularSwitch, BOOL bDirect)
{
  Call(SCI_SETMOUSESELECTIONRECTANGULARSWITCH, static_cast<WPARAM>(mouseSelectionRectangularSwitch), 0, bDirect);
}

BOOL CScintillaCtrl::GetMouseSelectionRectangularSwitch(BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_GETMOUSESELECTIONRECTANGULARSWITCH, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETMULTIPLESELECTION, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETADDITIONALSELECTIONTYPING, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETADDITIONALCARETSBLINK, 0, 0, bDirect));
}
...
{
  return static_cast<BOOL>(Call(SCI_GETADDITIONALCARETSVISIBLE, 0, 0, bDirect));
}

int CScintillaCtrl::GetSelections(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETSELECTIONS, 0, 0, bDirect));
}

BOOL CScintillaCtrl::GetSelectionEmpty(BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_GETSELECTIONEMPTY, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_SETSELECTION, static_cast<WPARAM>(caret), static_cast<LPARAM>(anchor), bDirect));
}

int CScintillaCtrl::AddSelection(int caret,int anchor, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_ADDSELECTION, static_cast<WPARAM>(caret), static_cast<LPARAM>(anchor), bDirect));
}

void CScintillaCtrl::DropSelectionN(int selection, BOOL bDirect)
{
  Call(SCI_DROPSELECTIONN, static_cast<WPARAM>(selection), 0, bDirect);
}
...
{
  return static_cast<int>(Call(SCI_GETMAINSELECTION, 0, 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_GETSELECTIONNCARET, static_cast<WPARAM>(selection), 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_GETSELECTIONNANCHOR, static_cast<WPARAM>(selection), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETSELECTIONNCARETVIRTUALSPACE, static_cast<WPARAM>(selection), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETSELECTIONNANCHORVIRTUALSPACE, static_cast<WPARAM>(selection), 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_GETSELECTIONNSTART, static_cast<WPARAM>(selection), 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_GETSELECTIONNEND, static_cast<WPARAM>(selection), 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_GETRECTANGULARSELECTIONCARET, 0, 0, bDirect));
}
...
{
  return static_cast<long>(Call(SCI_GETRECTANGULARSELECTIONANCHOR, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETRECTANGULARSELECTIONCARETVIRTUALSPACE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETRECTANGULARSELECTIONANCHORVIRTUALSPACE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETVIRTUALSPACEOPTIONS, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETRECTANGULARSELECTIONMODIFIER, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETADDITIONALSELALPHA, 0, 0, bDirect));
}
...
{
  return static_cast<COLORREF>(Call(SCI_GETADDITIONALCARETFORE, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_CHANGELEXERSTATE, static_cast<WPARAM>(start), static_cast<LPARAM>(end), bDirect));
}

int CScintillaCtrl::ContractedFoldNext(int lineStart, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_CONTRACTEDFOLDNEXT, static_cast<WPARAM>(lineStart), 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETIDENTIFIER, 0, 0, bDirect));
}
...
{
  Call(SCI_RGBAIMAGESETSCALE, static_cast<WPARAM>(scalePercent), 0, bDirect);
}
...
{
  return static_cast<int>(Call(SCI_GETTECHNOLOGY, 0, 0, bDirect));
}

int CScintillaCtrl::CreateLoader(int bytes, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_CREATELOADER, static_cast<WPARAM>(bytes), 0, bDirect));
}
...
{
  Call(SCI_VCHOMEDISPLAY, 0, 0, bDirect);
}

void CScintillaCtrl::VCHomeDisplayExtend(BOOL bDirect)
{
  Call(SCI_VCHOMEDISPLAYEXTEND, 0, 0, bDirect);
}

BOOL CScintillaCtrl::GetCaretLineVisibleAlways(BOOL bDirect)
{
  return static_cast<BOOL>(Call(SCI_GETCARETLINEVISIBLEALWAYS, 0, 0, bDirect));
}

void CScintillaCtrl::SetCaretLineVisibleAlways(BOOL bAlwaysVisible, BOOL bDirect)
{
  Call(SCI_SETCARETLINEVISIBLEALWAYS, static_cast<WPARAM>(bAlwaysVisible), 0, bDirect);
}

void CScintillaCtrl::SetLineEndTypesAllowed(int lineEndBitSet, BOOL bDirect)
{
  Call(SCI_SETLINEENDTYPESALLOWED, static_cast<WPARAM>(lineEndBitSet), 0, bDirect);
}

int CScintillaCtrl::GetLineEndTypesAllowed(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETLINEENDTYPESALLOWED, 0, 0, bDirect));
}

int CScintillaCtrl::GetLineEndTypesActive(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETLINEENDTYPESACTIVE, 0, 0, bDirect));
}

void CScintillaCtrl::SetRepresentation(const char* encodedCharacter, const char* representation, BOOL bDirect)
{
  Call(SCI_SETREPRESENTATION, reinterpret_cast<WPARAM>(encodedCharacter), reinterpret_cast<LPARAM>(representation), bDirect);
}

int CScintillaCtrl::GetRepresentation(const char* encodedCharacter, char* representation, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETREPRESENTATION, reinterpret_cast<WPARAM>(encodedCharacter), reinterpret_cast<LPARAM>(representation), bDirect));
}

void CScintillaCtrl::ClearRepresentation(const char* encodedCharacter, BOOL bDirect)
{
  Call(SCI_CLEARREPRESENTATION, reinterpret_cast<WPARAM>(encodedCharacter), 0, bDirect);
}
...
{
  return static_cast<int>(Call(SCI_GETLEXER, 0, 0, bDirect));
}
...
{
  return static_cast<int>(Call(SCI_GETPROPERTY, reinterpret_cast<WPARAM>(key), reinterpret_cast<LPARAM>(buf), bDirect));
}

int CScintillaCtrl::GetPropertyExpanded(const char* key, char* buf, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETPROPERTYEXPANDED, reinterpret_cast<WPARAM>(key), reinterpret_cast<LPARAM>(buf), bDirect));
}

int CScintillaCtrl::GetPropertyInt(const char* key, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETPROPERTYINT, reinterpret_cast<WPARAM>(key), 0, bDirect));
}

int CScintillaCtrl::GetStyleBitsNeeded(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETSTYLEBITSNEEDED, 0, 0, bDirect));
}

int CScintillaCtrl::GetLexerLanguage(char* text, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETLEXERLANGUAGE, 0, reinterpret_cast<LPARAM>(text), bDirect));
}

void* CScintillaCtrl::PrivateLexerCall(int operation, void* pointer, BOOL bDirect)
{
  return reinterpret_cast<void*>(Call(SCI_PRIVATELEXERCALL, static_cast<WPARAM>(operation), reinterpret_cast<LPARAM>(pointer), bDirect));
}

int CScintillaCtrl::PropertyNames(char* names, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_PROPERTYNAMES, 0, reinterpret_cast<LPARAM>(names), bDirect));
}

int CScintillaCtrl::PropertyType(const char* name, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_PROPERTYTYPE, reinterpret_cast<WPARAM>(name), 0, bDirect));
}

int CScintillaCtrl::DescribeProperty(const char* name, char* description, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_DESCRIBEPROPERTY, reinterpret_cast<WPARAM>(name), reinterpret_cast<LPARAM>(description), bDirect));
}

int CScintillaCtrl::DescribeKeyWordSets(char* descriptions, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_DESCRIBEKEYWORDSETS, 0, reinterpret_cast<LPARAM>(descriptions), bDirect));
}

int CScintillaCtrl::GetLineEndTypesSupported(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETLINEENDTYPESSUPPORTED, 0, 0, bDirect));
}

int CScintillaCtrl::AllocateSubStyles(int styleBase, int numberStyles, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_ALLOCATESUBSTYLES, static_cast<WPARAM>(styleBase), static_cast<LPARAM>(numberStyles), bDirect));
}

int CScintillaCtrl::GetSubStylesStart(int styleBase, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETSUBSTYLESSTART, static_cast<WPARAM>(styleBase), 0, bDirect));
}

int CScintillaCtrl::GetSubStylesLength(int styleBase, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETSUBSTYLESLENGTH, static_cast<WPARAM>(styleBase), 0, bDirect));
}

int CScintillaCtrl::GetStyleFromSubStyle(int subStyle, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETSTYLEFROMSUBSTYLE, static_cast<WPARAM>(subStyle), 0, bDirect));
}

int CScintillaCtrl::GetPrimaryStyleFromStyle(int style, BOOL bDirect)
{
  return static_cast<int>(Call(SCI_GETPRIMARYSTYLEFROMSTYLE, static_cast<WPARAM>(style), 0, bDirect));
}

void CScintillaCtrl::FreeSubStyles(BOOL bDirect)
{
  Call(SCI_FREESUBSTYLES, 0, 0, bDirect);
}

void CScintillaCtrl::SetIdentifiers(int style, const char* identifiers, BOOL bDirect)
{
  Call(SCI_SETIDENTIFIERS, static_cast<WPARAM>(style), reinterpret_cast<LPARAM>(identifiers), bDirect);
}

int CScintillaCtrl::DistanceToSecondaryStyles(BOOL bDirect)
{
  return static_cast<int>(Call(SCI_DISTANCETOSECONDARYSTYLES, 0, 0, bDirect));
}
