...
//Notifications
  ...
  virtual void OnIndicatorClick(SCNotification* pSCNotification);
  virtual void OnIndicatorRelease(SCNotification* pSCNotification);
  virtual void OnAutoCCharDeleted(SCNotification* pSCNotification);
  virtual void OnAutoCCancelled(SCNotification* pSCNotification);
  virtual void OnHotspotReleaseClick(SCNotification* pSCNotification);
  virtual void OnFocusIn(SCNotification* pSCNotification);
  virtual void OnFocusOut(SCNotification* pSCNotification);
