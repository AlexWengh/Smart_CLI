...
//Unicode support
  ...
  void ChangeInsertion(int length, const wchar_t* text, BOOL bDirect = TRUE);
  ...
  void SetIdentifiers(int style, const wchar_t* identifiers, BOOL bDirect = TRUE);
...
//Auto generated using the "ConvertScintillaiface.js" script
  ...
  void ChangeInsertion(int length, const char* text, BOOL bDirect = TRUE);
  ...
  void ClearTabStops(int line, BOOL bDirect = TRUE);
  void AddTabStop(int line, int x, BOOL bDirect = TRUE);
  int GetNextTabStop(int line, int x, BOOL bDirect = TRUE);
  void SetCodePage(int codePage, BOOL bDirect = TRUE);
  int GetIMEInteraction(BOOL bDirect = TRUE);
  void SetIMEInteraction(int imeInteraction, BOOL bDirect = TRUE);
  ...
  void MarkerSetBackSelected(int markerNumber, COLORREF back, BOOL bDirect = TRUE);
  void MarkerEnableHighlight(BOOL enabled, BOOL bDirect = TRUE);
  ...
  void StyleSetSizeFractional(int style, int sizeInHundredthPoints, BOOL bDirect = TRUE);
  int StyleGetSizeFractional(int style, BOOL bDirect = TRUE);
  void StyleSetWeight(int style, int weight, BOOL bDirect = TRUE);
  int StyleGetWeight(int style, BOOL bDirect = TRUE);
  ...
  int CountCharacters(int startPos, int endPos, BOOL bDirect = TRUE);
  ...
  void SetEmptySelection(long pos, BOOL bDirect = TRUE);
  ...
  void ScrollRange(long secondary, long primary, BOOL bDirect = TRUE);
  ...
  void CallTipSetPosStart(int posStart, BOOL bDirect = TRUE);
  ...
  void CallTipSetPosition(BOOL above, BOOL bDirect = TRUE);
  ...
  BOOL GetAllLinesVisible(BOOL bDirect = TRUE);
  ...
  void FoldLine(int line, int action, BOOL bDirect = TRUE);
  void FoldChildren(int line, int action, BOOL bDirect = TRUE);
  void ExpandChildren(int line, int level, BOOL bDirect = TRUE);
  void FoldAll(int action, BOOL bDirect = TRUE);
  void EnsureVisible(int line, BOOL bDirect = TRUE);
  void SetAutomaticFold(int automaticFold, BOOL bDirect = TRUE);
  int GetAutomaticFold(BOOL bDirect = TRUE);
  ...
  int GetPhasesDraw(BOOL bDirect = TRUE);
  void SetPhasesDraw(int phases, BOOL bDirect = TRUE);
  ...
  void BraceHighlightIndicator(BOOL useBraceHighlightIndicator, int indicator, BOOL bDirect = TRUE);
  void BraceBadLight(long pos, BOOL bDirect = TRUE);
  void BraceBadLightIndicator(BOOL useBraceBadLightIndicator, int indicator, BOOL bDirect = TRUE);
  ...
  long PositionRelative(long pos, int relative, BOOL bDirect = TRUE);
  ...
  void AutoCSetMulti(int multi, BOOL bDirect = TRUE);
  int AutoCGetMulti(BOOL bDirect = TRUE);
  void AutoCSetOrder(int order, BOOL bDirect = TRUE);
  int AutoCGetOrder(BOOL bDirect = TRUE);
  ...
  void IndicSetOutlineAlpha(int indicator, int alpha, BOOL bDirect = TRUE);
  int IndicGetOutlineAlpha(int indicator, BOOL bDirect = TRUE);
  ...
  void SetMarginOptions(int marginOptions, BOOL bDirect = TRUE);
  int GetMarginOptions(BOOL bDirect = TRUE);
  ...
  void ReleaseAllExtendedStyles(BOOL bDirect = TRUE);
  int AllocateExtendedStyles(int numberStyles, BOOL bDirect = TRUE);
  ...
  void SetMouseSelectionRectangularSwitch(BOOL mouseSelectionRectangularSwitch, BOOL bDirect = TRUE);
  BOOL GetMouseSelectionRectangularSwitch(BOOL bDirect = TRUE);
  ...
  BOOL GetSelectionEmpty(BOOL bDirect = TRUE);
  ...
  void DropSelectionN(int selection, BOOL bDirect = TRUE);
  ...
  void MoveSelectedLinesUp(BOOL bDirect = TRUE);
  void MoveSelectedLinesDown(BOOL bDirect = TRUE);
  void SetIdentifier(int identifier, BOOL bDirect = TRUE);
  int GetIdentifier(BOOL bDirect = TRUE);
  void RGBAImageSetWidth(int width, BOOL bDirect = TRUE);
  void RGBAImageSetHeight(int height, BOOL bDirect = TRUE);
  void RGBAImageSetScale(int scalePercent, BOOL bDirect = TRUE);
  void MarkerDefineRGBAImage(int markerNumber, const char* pixels, BOOL bDirect = TRUE);
  void RegisterRGBAImage(int type, const char* pixels, BOOL bDirect = TRUE);
  void ScrollToStart(BOOL bDirect = TRUE);
  void ScrollToEnd(BOOL bDirect = TRUE);
  ...
  void VCHomeDisplay(BOOL bDirect = TRUE);
  void VCHomeDisplayExtend(BOOL bDirect = TRUE);
  BOOL GetCaretLineVisibleAlways(BOOL bDirect = TRUE);
  void SetCaretLineVisibleAlways(BOOL bAlwaysVisible, BOOL bDirect = TRUE);
  void SetRepresentation(const char* encodedCharacter, const char* representation, BOOL bDirect = TRUE);
  int GetRepresentation(const char* encodedCharacter, char* representation, BOOL bDirect = TRUE);
  void ClearRepresentation(const char* encodedCharacter, BOOL bDirect = TRUE);
  ...
  void* PrivateLexerCall(int operation, void* pointer, BOOL bDirect = TRUE);
  ...
  void SetLineEndTypesAllowed(int lineEndBitSet, BOOL bDirect = TRUE);
  int GetLineEndTypesAllowed(BOOL bDirect = TRUE);
  int GetLineEndTypesActive(BOOL bDirect = TRUE);
  int GetLineEndTypesSupported(BOOL bDirect = TRUE);
  int AllocateSubStyles(int styleBase, int numberStyles, BOOL bDirect = TRUE);
  int GetSubStylesStart(int styleBase, BOOL bDirect = TRUE);
  int GetSubStylesLength(int styleBase, BOOL bDirect = TRUE);
  int GetStyleFromSubStyle(int subStyle, BOOL bDirect = TRUE);
  int GetPrimaryStyleFromStyle(int style, BOOL bDirect = TRUE);
  void FreeSubStyles(BOOL bDirect = TRUE);
  void SetIdentifiers(int style, const char* identifiers, BOOL bDirect = TRUE);
  int DistanceToSecondaryStyles(BOOL bDirect = TRUE);
  int GetSubStyleBases(char* styles, BOOL bDirect = TRUE);
